...
const SectionPolicy: FunctionComponent = () => {
  ...
  return (
    ...
    <p>Welcome to <strong>PAYLEND LIMITED</strong>.</p>
                    <p>
                        <strong>PAYLEND LIMITED </strong>(“us”, “we”, or “our”) operates <strong>www.paylend.com</strong>
                    ...
                    <p>
                        ...
                        the Privacy Policy constitutes your agreement with us (“<strong>agreement</strong>”).
                    </p>
                </div>
<b>2. Definitions</b>
<p>
                        <strong>SERVICE</strong> means the www.paylend.com website operated by PAYLEND LIMITED.
                    </p>
                    <p>
                        <strong>PERSONAL DATA</strong> means data about a living individual who can be identified
                        from those data (or from those and other information either in our possession or likely to come into
                        our possession).
                    </p>
                    <p>
                        <strong>USAGE DATA</strong> is data collected automatically either generated by the use of Service
                        or from Service infrastructure itself (for example, the duration of a page visit). COOKIES are small
...
<p>
                    ...
                    <ol>
                        <li>0.1. <strong>Session Cookies</strong>: We use Session Cookies to operate our Service.</li>
                        <li>0.2. <strong>Preference Cookies</strong>: We use Preference Cookies to remember your preferences
                            and various settings.</li>
                        <li>0.3. <strong>Security Cookies</strong>: We use Security Cookies for security purposes.</li>
                        <li>0.4. <strong>Advertising Cookies</strong>: Advertising Cookies are used to serve you with
...
<p>
                        ...
                        agreements, information on bonuses and compensation, information on marital status,
                        family members, social security (or other taxpayer identification) number, office location
                        and other data.
                    </p>
                {/* </div> */}
...
<p>
                        PAYLEND LIMITED uses the collected data for various purposes:
                    <ol>
                        <li>0.1. to provide and maintain our Service;</li>
                        <li>0.2. to notify you about changes to our Services;</li>
                        <li>0.3. to allow you to participate in interactive features of our Services when you choose to
                            do so;</li>
                        <li>0.4. to provide customer support;</li>
                        <li>0.5. to gather analysis or valuable information so that we can improve our Services;</li>
                        <li>0.6. to monitor the usage of our Services;</li>
                        <li>0.7. to detect, prevent and address technical issues;</li>
                        <li>0.8. to fulfil any other purpose for which you provide it;</li>
                        <li>0.9. to carry out our obligations and enforce our rights arising from any contracts entered
                            into between you and us, including for billing and collection;</li>
                        <li>0.10. to provide you with notices about your account and/or subscription, including
                            expiration and renewal notices, email-instructions, etc.;</li>
                        <li>0.11. to provide you with news, special offers and general information about other goods,
...
<p>
                        ...
                        located outside of your state, province, country, county or other governmental jurisdiction where
                    ...
                    <p>
                        ...
                        transfer the data, including Personal Data, to Kenya and process it there.
                    </p>
                    <p>
                    ...
                    <p>
                        PAYLEND LIMITED will take all the steps reasonably necessary to ensure that your data is treated
...
<p>
                    ...
                    <ol>
                        <li><strong>0.1. Business Transaction.</strong>
                            If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal
                            Data may be transferred.</li>
                        <li><strong>0.2. Other cases. We may disclose your information also</strong>:</li>
                        <li>0.2.1. to our subsidiaries and affiliates;</li>
                        <li>0.2.2. to contractors, service providers, and other third parties we use to support our
                            business;</li>
                        ...
                        <li>e believe disclosure is necessary or appropriate to protect the rights, property,
                            or safety of the Company, our customers, or others.</li>
                    </ol>
                    </p>
...
<b>15. No Use Of Platform By Minors </b>
...
<p>Please send your feedback, comments, requests for technical support: <br />
    ...
    By email:   care@paylend.africa </p>     <br />
   <p> By visiting this page on our website: <a href="https://paylendafrica.netlify.app/">paylend.africa </a>   </p>
